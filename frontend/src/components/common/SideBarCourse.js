...
class SideBarCourse extends React.Component {
  ...
  render() {
    const { classes, theme, courseDetails } = this.props;
    //const { courseDetails } = this.props.courseDetails;
...
SideBarCourse.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired
};

export default withStyles(styles, { withTheme: true })(SideBarCourse);
